    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h1>{{ $org->name }} : Assign Product</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('organization.product.store',$org->id) }}" method="post" class="form form-horizontal create-form">
                    @csrf
                    ...
                    <div class="form-group form-row">
                        <button type="submit" class="btn btn-outline-dark btn-sm ml-auto">Assign Product</button>
                    </div>
                </form>
            </div>
        </div>
